...
const blockscoutStatsChains: Record<string, ChainConfig> = {
  ...
  aurora: { chain: CHAIN.AURORA, baseUrl: "https://aurorascan.dev", version: 2, start: "2021-04-15" },
  ...
  mode: { chain: CHAIN.MODE, baseUrl: "https://explorer.mode.network", version: 2, start: "2023-11-16" },
  ...
  gnosis: { chain: CHAIN.XDAI, baseUrl: "https://blockscout.com/xdai/mainnet", version: 2, start: "2018-10-08" },
  zetachain: { chain: CHAIN.ZETA, baseUrl: "https://zetachain.blockscout.com", version: 2, start: "2024-01-24" },
